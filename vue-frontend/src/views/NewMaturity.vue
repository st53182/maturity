<template>
  <div class="new-shell">
    <div class="new-shell__header">
      <div class="new-shell__title">Maturity</div>
      <div class="new-shell__subtitle">
        Новый дизайн этой страницы — в работе. Пока используем текущий функционал в новой оболочке.
      </div>
    </div>
...
<script>
import CreateMaturityLink from "@/views/CreateMaturityLink.vue";

export default {
  components: { CreateMaturityLink },
};
</script>
...
.new-shell::before {
  ...
  height: 420px;
  border-radius: 50%;
  background: radial-gradient(circle, rgba(0, 194, 255, 0.16), rgba(0, 194, 255, 0));
  pointer-events: none;
}

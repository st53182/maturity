...
from agile_product_workshops import bp_agile_workshops
from workshop_copilot import bp_workshop_copilot
...
app.register_blueprint(bp_agile_workshops)
app.register_blueprint(bp_workshop_copilot)

    ...
    <main>
      ...
      <section class="features">
        <div class="feature-card">
          ...
          <h3>Оценка Командной-зрелости</h3>
          <p>Получите рекомендации по улучшению командной динамики, ролей и процессов с помощью ИИ-анализа. Отслеживайте прогресс во времени и формируйте осознанные цели для роста команды использую нашу платформу.</p>
        </div>
        <div class="feature-card">
          <img src="/icons/motivation.png" alt="Мотивация" />
          <h3>Мотивация по DISC</h3>
          <p>Интерактивное приложение, которое помогает вам понять, что действительно мотивирует ваших сотрудников. Получайте персонализированные рекомендации и краткие профили по каждому члену команды — всё внутри одной платформы.</p>
        </div>
        <div class="feature-card">

...
const routes = [
  ...
  {path: '/agile-training/product-stories', name: 'AgileWorkshopFacilitatorProductStories', component: () => import('@/views/AgileWorkshopFacilitator.vue'), meta: { requiresAuth: true, exerciseKey: 'product_stories' }},
  {path: '/agile-training/user-story-map', name: 'AgileWorkshopFacilitatorUserStoryMap', component: () => import('@/views/AgileWorkshopFacilitator.vue'), meta: { requiresAuth: true, exerciseKey: 'user_story_map' }},
  {path: '/agile-training/kanban-system', name: 'AgileWorkshopFacilitatorKanban', component: () => import('@/views/AgileWorkshopFacilitator.vue'), meta: { requiresAuth: true, exerciseKey: 'kanban_system' }},
